    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-700">
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[600px]">
        ...
        <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-sm bg-hooke-900 min-h-[400px]">
           ...
           <div className="absolute inset-0 bg-[url('C:\Users\Nando\Documents\Hooke_site\hooke-store\public\camiseta-vintage-beetle.jpg')] bg-cover bg-center opacity-80 group-hover:scale-105 transition-transform duration-700" />
           {/* --------------------- */}
