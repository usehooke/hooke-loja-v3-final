        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs font-medium tracking-wide">
              ...
              <li><Link href="/colecao" className="hover:text-gray-300 transition-colors">Lançamentos</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs font-medium tracking-wide">
              ...
              <li><Link href="#" className="hover:text-gray-300 transition-colors">Trocas e Devoluções</Link></li>
              <li><Link href="#" className="hover:text-gray-300 transition-colors">Guia de Medidas</Link></li>
            </ul>
          </div>
