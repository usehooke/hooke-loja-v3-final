                ...
                <div className="bg-white border border-hooke-900 overflow-x-auto rounded-none">
                                    ...
                                    <tr key={order.id} className={`border-b border-gray-200 last:border-0 hover:bg-gray-50 transition-colors`}>
                                        ...
                                        <td className="p-4 text-right align-middle">
                                            <div className="flex flex-col gap-2 w-full">
                                                ...
                                                {order.trackingCode && order.customer.phone && (
                                                    <button
                    ...
                    {orders.length === 0 && (
                        <div className="p-16 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Nenhum pedido registrado ainda.</p>
                            <p className="text-[10px] uppercase text-gray-400 mt-2">Os pedidos aparecerão aqui sincronizados com o Mercado Pago.</p>
                        </div>
                    )}
                </div>
            </div>
