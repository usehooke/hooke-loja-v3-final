...
import { Check, ArrowRight, Zap, Shirt, Wind, Ruler, Star, ChevronDown, ShieldCheck, Dumbbell, Layers, Sun, Repeat } from "lucide-react";
import { PRODUTOS } from "@/data/catalogo";

// ==================================================================================
// 🟢 LÓGICA DE PRECIFICAÇÃO DINÂMICA (REGATAS)
// ==================================================================================
...
// ==================================================================================
// 🟢 ÁREA DE EDIÇÃO SEGURA - VERSÃO REGATAS CANELADAS
// ==================================================================================
...
export const metadata = {
    title: `Regatas | ${CONFIG.hero.titulo_principal}`,
